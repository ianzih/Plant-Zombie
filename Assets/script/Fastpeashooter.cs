...
public class Fastpeashooter : Plantbase
{
    ...
    private void Attack()
    {
        ...
        Firebullet fastbullet = GameObject.Instantiate<GameObject>(bullet_load, transform.position + creatBulletOffsetPos, Quaternion.identity, transform).GetComponent<Firebullet>();
        fastbullet.init_bullet(pea_attackval);
        CDEnter();
        canattack = false;
    }
