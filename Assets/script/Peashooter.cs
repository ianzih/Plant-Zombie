...
public class Peashooter : Plantbase
{
    ...
    private void Attack()
    {
        ...
        Bullet bullet =GameObject.Instantiate<GameObject>(bullet_load, transform.position + creatBulletOffsetPos, Quaternion.identity, transform).GetComponent<Bullet>();
        bullet.init_bullet(pea_attackval);
        CDEnter();
        canattack = false;
    }
